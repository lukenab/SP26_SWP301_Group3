...
<div class="mb-4">
    <div class="content-header">
        <div>
            <h1 class="page-title">Delete Assessment</h1>
        </div>
    ...
    <div aria-label="breadcrumb">
        <ol class="breadcrumb mb-1">
            ...
            <li class="breadcrumb-item active" aria-current="page">Delete Assessment</li>
        </ol>
    </div>
</div>
            ...
            <form action="assessment" method="post" class="form-body">
                ...
                <div class="form-row">
                    <div class="form-group" style="width:100%">
                        ...
                        <input type="text" id="assessmentName" value="${assessment.assessmentName}" readonly>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group" style="width:100%">
                        ...
                        <input type="text" id="weight" value="${assessment.weight}%" readonly>
                    </div>
                </div>

                <div class="alert alert-warning" role="alert">
                    <i class='bx bx-exclamation-circle'></i>
                    <strong>Warning:</strong> This action will delete the assessment permanently. This cannot be undone.
                </div>
