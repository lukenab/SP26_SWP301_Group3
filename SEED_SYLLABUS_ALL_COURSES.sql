...
-- General English Pre-Intermediate (B1)
...
-- General English Intermediate (B2)
...
-- IELTS Preparation (Band 4.0 - 5.5)
...
-- IELTS Intensive (Target Band 6.5)
...
PRINT 'Old syllabus data removed and new syllabus seed inserted successfully.';
GO
