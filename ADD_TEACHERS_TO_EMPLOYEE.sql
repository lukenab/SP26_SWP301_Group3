...
-- Add Nguyễn Thị Thu Lan (UserID = 4) to Employee table
...
-- Update Lê Nhựt Huy (UserID = 9) from Admin (RoleID = 1) to Teacher (RoleID = 4)
UPDATE [dbo].[User]
SET [RoleID] = 4, [Status] = 1
WHERE [UserID] = 9
GO

-- Add Lê Nhựt Huy (UserID = 9) to Employee table
INSERT INTO [dbo].[Employee] ([EmployeeID], [HireDate], [Education], [Experience])
...
PRINT 'UserID 4: Nguyễn Thị Thu Lan - Already a teacher, now in Employee'
PRINT 'UserID 9: Lê Nhựt Huy - Changed from Admin to Teacher, added to Employee'
GO
